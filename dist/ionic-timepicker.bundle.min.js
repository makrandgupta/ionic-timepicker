...
function(i) {
    ...
    this.configTimePicker = function(e) {
        ...
        function o(i, e) {
            r.time.hours = Math.floor(i / 3600);
            var t = i % 3600;
            12 == e && (r.time.hours >= 12 ? (r.time.meridian = "PM", r.time.hours > 12 && (r.time.hours -= 12)) : r.time.meridian = "AM"), 0 === r.time.hours && (r.time.hours = 12), r.time.minutes = t / 60, r.time.hours = Math.floor(r.time.hours), r.time.minutes = Math.floor(r.time.minutes), 1 == r.time.hours.toString().length && (r.time.hours = "0" + r.time.hours), 1 == r.time.minutes.toString().length && (r.time.minutes = "0" + r.time.minutes), r.time.format = r.mainObj.format
        }
        var m = {},
            r = e.$new();
